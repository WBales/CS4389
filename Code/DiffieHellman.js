...
class Bob() {
  constructor(bob, public_prime_base, public_prime_modulus, bob_priv_key, alice_pub_key, bob_pub_key){
    ...
    var B = bob_encrypt_shared_secret_Key_Outgoing(b);     // gets the shared secret key for the Encryption of Bob's message
    var s_key_Bob = decrypt_Alice_Incoming(A);             // gets the shared secret key for the Decryption of Alice's message
...
class Alice {
  constructor(alice, public_prime_base, public_prime_modulus, alice_priv_key, alice_pub_key, bob_pub_key){
  ...
  var B = alice_encrypt_shared_secret_Key(a); // gets the shared secret key for the Encryption of Alice's message
  var s_key_Bob = decrypt_Bob_Incoming(B);             // gets the shared secret key for the Decryption of Bob's message
...
function decrypt_Bob_Incoming(B){        // Bob's Decryption algorithm
  ...
  (function(){
  "use strict";
function Cookie_Cutter_Function(message){           // This is just a quick skeleton of a method for saving time: copy/paste
